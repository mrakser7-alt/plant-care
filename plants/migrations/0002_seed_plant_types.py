# миграция которая заливает в базу начальный список видов растений
# запускается один раз когда первый раз накатываешь migrate
# чтобы в форме выбора вида сразу что-то было

from django.db import migrations


# (название, латынь, эмодзи, дней_между_поливами, дней_между_пересадками, описание)
SEED = [
